...
btncorbasepreto.addEventListener('click', function(e){
  document.querySelectorAll(".corbase").forEach(v => v.style.fill = "#E2DAC8");
  document.getElementById('CB').style.backgroundColor = "#E2DAC8";
});
//base azul
const btncorbaseazul = document.getElementById('bluebase');
btncorbaseazul.addEventListener('click', function(e){
  document.querySelectorAll(".corbase").forEach(v => v.style.fill = "#EFC46F");
  document.getElementById('CB').style.backgroundColor = "#EFC46F";
});    
//base vermelha
const btncorbasevermelha = document.getElementById('redbase');
btncorbasevermelha.addEventListener('click', function(e){
  document.querySelectorAll(".corbase").forEach(v => v.style.fill = "#B7B2A6");
  document.getElementById('CB').style.backgroundColor = "#B7B2A6";
});  
//base amarela
const btncorbaseamarela = document.getElementById('yellowbase');
btncorbaseamarela.addEventListener('click', function(e){
  document.querySelectorAll(".corbase").forEach(v => v.style.fill = "#A9BCC7");
  document.getElementById('CB').style.backgroundColor = "#A9BCC7";
});  
//base verde
const btncorbaseverde = document.getElementById('greenbase');
btncorbaseverde.addEventListener('click', function(e){
  document.querySelectorAll(".corbase").forEach(v => v.style.fill = "#7A98C1");
  document.getElementById('CB').style.backgroundColor = "#7A98C1";
});  

document.getElementById('base1').addEventListener('click', function(e){
  document.querySelectorAll(".corbase").forEach(v => v.style.fill = "#7088AC");
  document.getElementById('CB').style.backgroundColor = "#7088AC";
});  
document.getElementById('base2').addEventListener('click', function(e){
  document.querySelectorAll(".corbase").forEach(v => v.style.fill = "#235F94");
  document.getElementById('CB').style.backgroundColor = "#235F94";
});  
  ...
  btncorbotoespreto.addEventListener('click', function(e){
    document.getElementById('botao').style.fill = "#E2DAC8";
    document.getElementById('BT').style.backgroundColor = "#E2DAC8";
  });
  //botoes azul
  const btncorbotoesazul = document.getElementById('bluebase1');
  btncorbotoesazul.addEventListener('click', function(e){
    document.getElementById('botao').style.fill = "#EFC46F";
    document.getElementById('BT').style.backgroundColor = "#EFC46F";
  });    
  //botoes vermelha
  const btncorbotoesvermelha = document.getElementById('redbase1');
  btncorbotoesvermelha.addEventListener('click', function(e){
    document.getElementById('botao').style.fill = "#B7B2A6";
    document.getElementById('BT').style.backgroundColor = "#B7B2A6";
  });  
  //botoes amarela
  const btncorbotoesamarela = document.getElementById('yellowbase1');
  btncorbotoesamarela.addEventListener('click', function(e){
    document.getElementById('botao').style.fill = "#A9BCC7";
    document.getElementById('BT').style.backgroundColor = "#A9BCC7";
  });  
  //botoes verde
  const btncorbotoesverde = document.getElementById('greenbase1');
  btncorbotoesverde.addEventListener('click', function(e){
    document.getElementById('botao').style.fill = "#7A98C1";
    document.getElementById('BT').style.backgroundColor = "#7A98C1";
  });  

  document.getElementById('base11').addEventListener('click', function(e){
    document.getElementById('botao').style.fill = "#7088AC";
    document.getElementById('BT').style.backgroundColor = "#7088AC";
  });  
  document.getElementById('base21').addEventListener('click', function(e){
    document.getElementById('botao').style.fill = "#235F94";
    document.getElementById('BT').style.backgroundColor = "#235F94";
  });  
  ...
  btncorgolaEpreto.addEventListener('click', function(e){
    document.getElementById('golaE').style.fill = "#E2DAC8";
    document.getElementById('golaEE').style.fill = "#E2DAC8";
    document.getElementById('ge').style.backgroundColor = "#E2DAC8";
  });
  //Gola exterior azul
  const btncorgolaEazul = document.getElementById('bluebase2');
  btncorgolaEazul.addEventListener('click', function(e){
    document.getElementById('golaE').style.fill = "#EFC46F";
    document.getElementById('golaEE').style.fill = "#EFC46F";
    document.getElementById('ge').style.backgroundColor = "#EFC46F";
  });    
  ...
  btncorgolaEvermelha.addEventListener('click', function(e){
    document.getElementById('golaE').style.fill = "#B7B2A6";
    document.getElementById('golaEE').style.fill = "#B7B2A6";
    document.getElementById('ge').style.backgroundColor = "#B7B2A6";
  });  
  ...
  btncorgolaEamarela.addEventListener('click', function(e){
    document.getElementById('golaE').style.fill = "#A9BCC7";
    document.getElementById('golaEE').style.fill = "#A9BCC7";
    document.getElementById('ge').style.backgroundColor = "#A9BCC7";
  });  
  //Gola exterior verde
  const btncorgolaEverde = document.getElementById('greenbase2');
  btncorgolaEverde.addEventListener('click', function(e){
    document.getElementById('golaE').style.fill = "#7A98C1";
    document.getElementById('golaEE').style.fill = "#7A98C1";
    document.getElementById('ge').style.backgroundColor = "#7A98C1";
  });  
  document.getElementById('base12').addEventListener('click', function(e){
    document.getElementById('golaE').style.fill = "#7088AC";
    document.getElementById('golaEE').style.fill = "#7088AC";
    document.getElementById('ge').style.backgroundColor = "#7088AC";
  });  
  document.getElementById('base22').addEventListener('click', function(e){
    document.getElementById('golaE').style.fill = "#235F94";
    document.getElementById('golaEE').style.fill = "#235F94";
    document.getElementById('ge').style.backgroundColor = "#235F94";
  });  
  ...
  btncorgolaIpreto.addEventListener('click', function(e){
    document.getElementById('golaI').style.fill = "#E2DAC8";
    document.getElementById('gi').style.backgroundColor = "#E2DAC8";
  });
  //Gola interior azul
  const btncorgolaIazul = document.getElementById('bluebase3');
  btncorgolaIazul.addEventListener('click', function(e){
    document.getElementById('golaI').style.fill = "#EFC46F";
    document.getElementById('gi').style.backgroundColor = "#EFC46F";
  });    
  ...
  btncorgolaIvermelha.addEventListener('click', function(e){
    document.getElementById('golaI').style.fill = "#B7B2A6";
    document.getElementById('gi').style.backgroundColor = "#B7B2A6";
  });  
  ...
  btncorgolaIamarela.addEventListener('click', function(e){
    document.getElementById('golaI').style.fill = "#A9BCC7";
    document.getElementById('gi').style.backgroundColor = "#A9BCC7";
  });  
  //Gola interior verde
  const btncorgolaIverde = document.getElementById('greenbase3');
  btncorgolaIverde.addEventListener('click', function(e){
    document.getElementById('golaI').style.fill = "#7A98C1";
    document.getElementById('gi').style.backgroundColor = "#7A98C1";
  });  
  document.getElementById('base13').addEventListener('click', function(e){
    document.getElementById('golaI').style.fill = "#7088AC";
    document.getElementById('gi').style.backgroundColor = "#7088AC";
  });  
  document.getElementById('base23').addEventListener('click', function(e){
    document.getElementById('golaI').style.fill = "#235F94";
    document.getElementById('gi').style.backgroundColor = "#235F94";
  });  
...
//punho branca
  ...
  btncorpunhopreto.addEventListener('click', function(e){
    document.getElementById('punho2').style.fill = "#E2DAC8";
    document.getElementById('punho1').style.fill = "#E2DAC8";
    document.getElementById('PU').style.backgroundColor = "#E2DAC8";
  });
  //punho azul
  const btncorpunhoazul = document.getElementById('bluebase4');
  btncorpunhoazul.addEventListener('click', function(e){
    document.getElementById('punho2').style.fill = "#EFC46F";
    document.getElementById('punho1').style.fill = "#EFC46F";
    document.getElementById('PU').style.backgroundColor = "#EFC46F";
  });    
  //punho vermelha
  const btncorpunhovermelha = document.getElementById('redbase4');
  btncorpunhovermelha.addEventListener('click', function(e){
    document.getElementById('punho2').style.fill = "#B7B2A6";
    document.getElementById('punho1').style.fill = "#B7B2A6";
    document.getElementById('PU').style.backgroundColor = "#B7B2A6";
  });  
  //punho amarela
  const btncorpunhoamarela = document.getElementById('yellowbase4');
  btncorpunhoamarela.addEventListener('click', function(e){
    document.getElementById('punho2').style.fill = "#A9BCC7";
    document.getElementById('punho1').style.fill = "#A9BCC7";
    document.getElementById('PU').style.backgroundColor = "#A9BCC7";
  });  
  //punho verde
  const btncorpunhoverde = document.getElementById('greenbase4');
  btncorpunhoverde.addEventListener('click', function(e){
    document.getElementById('punho2').style.fill = "#7A98C1";
    document.getElementById('punho1').style.fill = "#7A98C1";
    document.getElementById('PU').style.backgroundColor = "#7A98C1";
  });
  ...
  btncorvistaEpreto.addEventListener('click', function(e){
    document.getElementById('vista2').style.fill = "#E2DAC8";
    document.getElementById('VE').style.backgroundColor = "#E2DAC8";
  });
  //vistaE azul
  const btncorvistaEazul = document.getElementById('bluebase5');
  btncorvistaEazul.addEventListener('click', function(e){
    document.getElementById('vista2').style.fill = "#EFC46F";
    document.getElementById('VE').style.backgroundColor = "#EFC46F";
  });    
  //vistaE vermelha
  const btncorvistaEvermelha = document.getElementById('redbase5');
  btncorvistaEvermelha.addEventListener('click', function(e){
    document.getElementById('vista2').style.fill = "#B7B2A6";
    document.getElementById('VE').style.backgroundColor = "#B7B2A6";
  });  
  //vistaE amarela
  const btncorvistaEamarela = document.getElementById('yellowbase5');
  btncorvistaEamarela.addEventListener('click', function(e){
    document.getElementById('vista2').style.fill = "#A9BCC7";
    document.getElementById('VE').style.backgroundColor = "#A9BCC7";
  });  
  //vistaE verde
  const btncorvistaEverde = document.getElementById('greenbase5');
  btncorvistaEverde.addEventListener('click', function(e){
    document.getElementById('vista2').style.fill = "#7A98C1";
    document.getElementById('VE').style.backgroundColor = "#7A98C1";
  });

  document.getElementById('base15').addEventListener('click', function(e){
    document.getElementById('vista2').style.fill = "#7088AC";
    document.getElementById('VE').style.backgroundColor = "##7088AC";
  });
  document.getElementById('base25').addEventListener('click', function(e){
    document.getElementById('vista2').style.fill = "#235F94";
    document.getElementById('VE').style.backgroundColor = "#235F94";
  });
